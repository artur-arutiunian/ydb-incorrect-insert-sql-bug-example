...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3326f82a-c084-4ea2-9255-17819bab99ad
```

> `3326f82a-c084-4ea2-9255-17819bab99ad` is the password of the certificate, you can change it to any password you want.
