        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutionDuration = table.Column<int>(type: "Int32", nullable: false),
                    ...
                    HttpStatusCode = table.Column<int>(type: "Int32", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TryCount = table.Column<short>(type: "Int16", nullable: false, defaultValue: (short)0),
                    CreationTime = table.Column<DateTime>(type: "Timestamp", nullable: false),
                    ...
                    IsAbandoned = table.Column<bool>(type: "Bool", nullable: false, defaultValue: false),
                    Priority = table.Column<byte>(type: "Uint8", nullable: false, defaultValue: (byte)15),
                    ExtraProperties = table.Column<string>(type: "Text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "Text", maxLength: 40, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsStatic = table.Column<bool>(type: "Bool", nullable: false),
                    ...
                    ValueType = table.Column<int>(type: "Int32", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "Timestamp", nullable: false),
                    ExtraProperties = table.Column<string>(type: "Text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "Text", maxLength: 40, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisibleToClients = table.Column<bool>(type: "Bool", nullable: false),
                    IsAvailableToHost = table.Column<bool>(type: "Bool", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MultiTenancySide = table.Column<byte>(type: "Uint8", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignedIn = table.Column<DateTime>(type: "Timestamp", nullable: false),
                    LastAccessed = table.Column<DateTime>(type: "Timestamp", nullable: true),
                    ExtraProperties = table.Column<string>(type: "Text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInherited = table.Column<bool>(type: "Bool", nullable: false),
                    IsEncrypted = table.Column<bool>(type: "Bool", nullable: false),
                    ExtraProperties = table.Column<string>(type: "Text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeType = table.Column<byte>(type: "Uint8", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Properties = table.Column<string>(type: "Text", nullable: true),
                    RedemptionDate = table.Column<DateTime>(type: "Timestamp", nullable: true),
